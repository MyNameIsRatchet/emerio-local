...
class EmerioEntity(Entity):
    ...
    def extra_state_attributes(self):
        return {
            ...
            "passive_updatedps_sent": self.device.passive_updatedps_sent,
            "power_sensor_entity_id": self.device.power_sensor_entity_id,
            "power_watts": self.device.power_watts,
            "power_fallback_active": self.device.power_fallback_active,
            "compressor_active": self.device.compressor_active,
